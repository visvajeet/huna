...
*/
  ...
  void startShareVideo(bool useScreen) async {
    ...
    if(useScreen) {
      ...
      stream = await navigator.getDisplayMedia(mediaConstraints);
    ...
    this._connection.getLocalStreams().clear();

    _localMediaStream = stream;

    this._connection.addStream(stream).then((value) => {

      this.emit(EventStream(session: this, originator: 'local', stream:  stream)),
      renegotiate(mediaConstraints)

    });

  }

  void stopShareVideo(bool useScreen) async {
