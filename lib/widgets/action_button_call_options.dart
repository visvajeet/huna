...
class ActionButtonCallOptions extends StatefulWidget {
  final String title;
...
class _ActionButtonState extends State<ActionButtonCallOptions> {
  @override
      ...
      children: <Widget>[
        GestureDetector(
            ...
            child: RawMaterialButton(
              ...
              shape: CircleBorder(side: BorderSide(width: 1, color: Colors.white70),),
              fillColor: !widget.checked ?  Colors.transparent : Colors.cyan,
